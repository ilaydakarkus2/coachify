...
async function main() {
  ...
  const assignments = await prisma.studentAssignment.createMany({
    data: [
      ...
      { studentId: allStudents[5].id, mentorId: mehmetMentor!.id, startDate: new Date('2025-03-08'),
        endDate: new Date('2025-03-20') },
      { studentId: allStudents[6].id, mentorId: efeMentor!.id, startDate: new Date('2025-03-12'),
        endDate: new Date('2025-03-18') },
